                  ...
                  PopupMenuButton(
                    ...
                    itemBuilder: (context) {
                      return [
                        ...
                        // To add dictionaries, this is more of a hack
                        // because i dont want to change the UI significantly
                        PopupMenuItem<int>(
                          value: 999,
                          child: Text("Import dict"),
                        ),
                      ];
                    },
                    onSelected: (value) {
                      if (value == 0) {
                        ...
                        manga.whenData((value) {
                          ...
                          pushToMangaReaderDetail(
                            ref: ref,
                            archiveId:
                                randomManga.isLocalArchive ?? false
                                    ? randomManga.id
                                    : null,
                            context: context,
