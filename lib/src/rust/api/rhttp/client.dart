...
// These functions are ignored (category: IgnoreBecauseNotAllowedOwner): `digest_ip`
            ...
            DnsSettings  createStaticResolverSync({required StaticDnsSettings settings }) => RustLib.instance.api.crateApiRhttpClientCreateStaticResolverSync(settings: settings);

DnsSettings  createDynamicResolverSync({required FutureOr<List<String>> Function(String) resolver }) => RustLib.instance.api.crateApiRhttpClientCreateDynamicResolverSync(resolver: resolver);
...
final Uint8List privateKey;
        ...
        bool operator ==(Object other) =>
            ...
            other is ClientCertificate &&
                ...
                && certificate == other.certificate&& privateKey == other.privateKey;
...
final DnsSettings? dnsSettings;
                ...
                const ClientSettings({this.timeoutSettings ,required this.throwOnStatusCode ,this.proxySettings ,this.redirectSettings ,this.tlsSettings ,this.dnsSettings ,});
        ...
        @override
        int get hashCode => timeoutSettings.hashCode^throwOnStatusCode.hashCode^proxySettings.hashCode^redirectSettings.hashCode^tlsSettings.hashCode^dnsSettings.hashCode;
        ...
        bool operator ==(Object other) =>
            ...
            other is ClientSettings &&
                runtimeType == other.runtimeType
                && timeoutSettings == other.timeoutSettings&& throwOnStatusCode == other.throwOnStatusCode&& proxySettings == other.proxySettings&& redirectSettings == other.redirectSettings&& tlsSettings == other.tlsSettings&& dnsSettings == other.dnsSettings;
...
final ProxyCondition condition;
        ...
        bool operator ==(Object other) =>
            ...
            other is CustomProxy &&
                runtimeType == other.runtimeType
                && url == other.url&& condition == other.condition;
...
final String? fallback;
        ...
        bool operator ==(Object other) =>
            ...
            other is StaticDnsSettings &&
                runtimeType == other.runtimeType
                && overrides == other.overrides&& fallback == other.fallback;
...
final Duration? keepAlivePing;
        ...
        bool operator ==(Object other) =>
            ...
            other is TimeoutSettings &&
                runtimeType == other.runtimeType
                && timeout == other.timeout&& connectTimeout == other.connectTimeout&& keepAliveTimeout == other.keepAliveTimeout&& keepAlivePing == other.keepAlivePing;
...
final TlsVersion? maxTlsVersion;
                ...
                const TlsSettings({required this.trustRootCertificates ,required this.trustedRootCertificates ,required this.verifyCertificates ,this.clientCertificate ,this.minTlsVersion ,this.maxTlsVersion ,});
        ...
        @override
        int get hashCode => trustRootCertificates.hashCode^trustedRootCertificates.hashCode^verifyCertificates.hashCode^clientCertificate.hashCode^minTlsVersion.hashCode^maxTlsVersion.hashCode;
        ...
        bool operator ==(Object other) =>
            ...
            other is TlsSettings &&
                runtimeType == other.runtimeType
                && trustRootCertificates == other.trustRootCertificates&& trustedRootCertificates == other.trustedRootCertificates&& verifyCertificates == other.verifyCertificates&& clientCertificate == other.clientCertificate&& minTlsVersion == other.minTlsVersion&& maxTlsVersion == other.maxTlsVersion;
