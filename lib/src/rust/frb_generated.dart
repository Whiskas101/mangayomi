...
import 'api/tokenizer_wrapper.dart';
import 'dart:async';
import 'dart:convert';
...
abstract class RustLibApi extends BaseApi {
  ...
  Future<List<TokenData>> crateApiTokenizerWrapperTokenizeText({
    required String input,
  });
...
class RustLibApiImpl extends RustLibApiImplPlatform implements RustLibApi {
  ...
  Future<String> crateApiTokenizerWrapperGetRustCwd() {
    return handler.executeNormal(
      NormalTask(
        ...
        constMeta: kCrateApiTokenizerWrapperGetRustCwdConstMeta,
        argValues: [],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta get kCrateApiTokenizerWrapperGetRustCwdConstMeta =>
  ...
  Future<List<TokenData>> crateApiTokenizerWrapperTokenizeText({
    ...
    return handler.executeNormal(
      NormalTask(
        ...
        constMeta: kCrateApiTokenizerWrapperTokenizeTextConstMeta,
        argValues: [input],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta get kCrateApiTokenizerWrapperTokenizeTextConstMeta =>
      const TaskConstMeta(debugName: "tokenize_text", argNames: ["input"]);
  ...
  TokenizerError dco_decode_tokenizer_error(dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return TokenizerError.values[raw as int];
  }
  ...
  TokenizerError sse_decode_tokenizer_error(SseDeserializer deserializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    var inner = sse_decode_i_32(deserializer);
    return TokenizerError.values[inner];
  }
